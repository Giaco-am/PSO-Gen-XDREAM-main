...
from xdream.core.utils.parameters import ArgParam
from xdream.core.utils.io_ import read_json
...
class ExperimentArgParams(Enum):
    ...
    HybridParamsVariant = ArgParam(name="hybrid_params_variant", type=str, help="Hybrid optimizer parameter set identifier (e.g., set1, set2, set3)")
    HybridParams       = ArgParam(name="hybrid_params",       type=str,   help="Hybrid optimizer parameter variant name")
    HybridParamsConfig = ArgParam(name="hybrid_params_config", type=str,   help="Hybrid optimizer parameter configuration dictionary")
    HybridParamsIndex = ArgParam(name="hybrid_params_index", type=int, help="Index to hybrid parameter combination in config file")
    # --- MAGIC METHODS ---
